    ...
    <div class="footer__wrapper w-full ">
        <div class="footer__container flex flex-col max-w-[100%]  border-t-[2px] border-t-[#0279C1] border-solid gap-[30px] mt-28 pb-32">
            <ul class="nav-list flex flex-row flex-wrap gap-5 pt-8 max-w-[990px]">
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">О курсах</li>
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">Повышение квалификации</li>
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">Профессиональная переподготовка</li>
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">Летние/Зимние/Осенние/Весенние ШКОЛЫ</li>
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">Курсы для детей</li>
                <li class=" text-[16px] xs:text-xl font-medium text-[#0279C1] pr-14">Вебинары</li>
            </ul>
