    ...
    <div class="course-container pt-20">
        <div class="course__profile flex flex-col px-0 xl:px-10 gap-[30px]">
            ...
            <div class="gradient-border bg-[#e5e5e514] grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4
                ...
                <div class=" profile__item relative w-full flex justify-center sm:justify-start xl:justify-center after:hidden xl:after:flex">
            ...
            <ul class="timetable__list  leading-[170%] text-[#fff] text-[16px] font-[200]  flex flex-col gap-[12px]">
                ...
                @foreach($course->section_about_what as $about_what_point)
                    <li class="timetable__list-item flex flex-row gap-[10px] items-center ">
                        <img class="w-[16px] sm:w-[22px] h-[16px] sm:h-[22px]" src="{{url('img/icons/info-dots.svg')}}" alt="">
        ...
        <ul class="timetable__container mt-8">
            @foreach($course->section_schedule as $accord)
                <li class="timetable__item relative border-t border-[#dbdbdb33] " x-data="{ selected: null, IsVisible: true }">
                    ...
                    <button class="timetable__head w-full px-4 py-6 text-left" type="button" @click="selected !== 1 ? selected = 1 : selected = null; IsVisible = !IsVisible">
                        <div class="flex items-center justify-between">
                            <h4 x-bind:style="IsVisible ? 'font-size:20px' : 'font-size:25px' "  class="text-[#fff]  font-[700] uppercase transition-[font-size] duration-150 w-[80%] sm:w-full ">
                                {{$accord['title']}}
                            </h4>
